...
setup(
    ...
    version="0.3.0",
    description="Open Interpreter-like CLI with beautiful UI, built on SmolaGents",
    ...
    entry_points={
        'console_scripts': [
            'interpreter-smol=interpreter_smol.core.interpreter:main',
            'interpreter-evolve=interpreter_smol.agents.evolving_agent:main',
            # Short aliases
