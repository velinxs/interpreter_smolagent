...
# Default system message that introduces the agent and its capabilities
DEFAULT_SYSTEM_MESSAGE = """## Welcome to interpreter-smol!

I'm a coding assistant built on SmolaGents, designed to write and execute code to help you accomplish tasks. I can:

- Write and run Python code to solve problems
- Search the web for information using DuckDuckGo
- Visit and extract information from webpages
- Perform data analysis and create visualizations
- Help you with programming tasks and questions

### Examples of what you can ask me:

```
"Calculate the first 20 prime numbers"
"Read my CSV file and create a chart showing sales trends"
"What's the current price of Ethereum? Show me a price comparison with Bitcoin"
"Help me understand how to use pandas for data cleaning"
"Write a script to rename all the image files in a directory"
```

Feel free to type 'exit' at any time to quit the session.
...
class Interpreter:
    ...
    def _initialize_agent(self, tool_names, imports):
        ...
        # Create custom prompt templates with system message if provided
...
def main():
    ...
    parser.add_argument("--no-system-message", action="store_true",
                        help="Disable the default system message")
    ...
    try:
        ...
        interpreter = Interpreter(
            ...
            system_message=None if args.no_system_message else DEFAULT_SYSTEM_MESSAGE
        )
